...
class GraphTreeNode():
    ...
    def __init__(self, baseTreeNode):
        '''
        This method initializes the GraphLuppNode object.
        The method takes the following parameters:
        - baseTreeNode: the base Luppolo node to rapresent in the graph.
        '''
        self.baseTreeNode = baseTreeNode
        self.grapAttributes = {}
        self.nodeId = str(id(baseTreeNode))
    ...
    def developGraph(self, graph):
        ...
        LuppoloLogger.logDebug(f"Developing Graph for node {self.baseTreeNode.name}")
        ...
        for child in self.baseTreeNode.children:
    ...
    def __constructNodeTable(self):
        ...
        # Add the node name
        label += f'<tr><td colspan="2"><b>{self.baseTreeNode.name}</b></td></tr>'
